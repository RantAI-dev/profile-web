          ...
          <div className="capt mt-50">
            <div className="parlx">
              <h2 className="custom-font">
                <span>Scientific Technology Consulting</span> RantAI Services
              </h2>
              <p>
                Tailored solutions in legacy app modernization, software performance optimization, full-stack development, and advanced machine learning operations.
              </p>
            </div>
...
export default { Header, AboutUs2, Services3, CallToAction };